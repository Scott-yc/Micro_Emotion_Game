...
export default class bianbian extends cc.Component {
    ...
    setMove(){
        ...
        // console.log(aPos)
        // let positionInParent = this.node.parent.convertToNodeSpaceAR(cc.v2(0, 0));
        ...
        // 计算角度（弧度）
        let angleRad = Math.atan2(aPos.y - this.node.y, aPos.x - this.node.x) *(180 / Math.PI);
        this.node.angle = angleRad;
